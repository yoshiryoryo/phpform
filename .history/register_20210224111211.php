...
<body>
    ...
    <script>
        ...
        const name_error_message = document.getElementById("name_2-error-message")
        ...
        //ボタンのdisabled制御
        const checkSuccess = () => {
            if (name_1.value && name_2.value  email.value && document.querySelector("input:checked[name=gender]")) {
