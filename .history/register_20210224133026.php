...
<body>
    <div class="border col-sm7">
        <h3>登録フォーム</h3>
        <form id="form">
            <input type="hidden" name="token" value="<?= $token ?>">
            <div class="form-group">
                <label>姓:</label>
                <input type="name" name="name_1" id="name_1" class="form-control">
                <span id="name_1-error-message">全角カナで入力してください</span>
            </div>
            <div>
                <label>名:</label>
                <input type="name" name="name_2" id="name_2" class="form-control">
            ...
            <div class="col-md">
                <button id="btn" class="btn btn-primary">確認画面</button>
            </div>
        </form>
    </div>
    <script>
